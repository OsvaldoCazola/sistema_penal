...
# Testar busca de artigos por número
Invoke-RestMethod -Uri "http://localhost:8080/api/artigos/numero/218?page=0&size=5" -Method GET -Header @{Authorization="Bearer $token"} | ConvertTo-Json -Depth 10
